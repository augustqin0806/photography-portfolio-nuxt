...
import Test from '../components/GalleryComparison.vue';
...
useHead({
  title: 'Grace Lyra - Portfolio',
  meta: [
    {
      name: 'description',
      content: "Hello there, I'm Grace Lyra – an intrepid explorer through the lens, on a relentless quest to capture the world's boundless wonders."
    }
  ]
})
